module.exports = Object.freeze(
    [
        {
            titulo: 'Información que es recogida',
            descripcion: `Nuestro sitio web podrá recoger información personal por ejemplo:
        ...
        {
            titulo: 'Uso de la información recogida',
            descripcion: `Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, 
        ...
        {
            titulo: 'Cookies',
            descripcion: `Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso
        ...
        },
        {
            ...
            descripcion: `Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés.
        ...
        {
            titulo: 'Control de su información personal',
            descripcion: `En cualquier momento usted puede restringir la recopilación o el uso de la información personal
            ...
            Controlsep Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.`
        },
    ]
);
